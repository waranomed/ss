...
for ( i = 0; i < punishment(i) ; i++)
{
   printf("i will not never cheat my neighboor ");
}

}

int quatriple(int num){
...
//    int numberInt=0, numberTripple=0;
   
//    printf("enter value numberInt:\t");
//    scanf("%d",&numberInt);

//    printf("the display quatriple is a next:\t%d", duble(numberInt));
//    printf("\nthe display quatriple is a next:\t%d", quatriple(numberInt));
//     printf("\nthe display quatriple is a next:\t%d", quatriple(duble(numberInt)));
//    return 0;
